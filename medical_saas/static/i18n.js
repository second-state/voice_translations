...
STRINGS.en = {
  ...
  // ── Landing page ────────────────────────────────────────────────────
  'home.title': 'Medical Interpreter — understand your doctor, keep what was said',
  ...
  'pricing.lede': 'Both plans are the same interpreter, with every language, every kind of visit and every safety rule. The difference is how much can be said.',
  ...
  'plan.free.f2': 'A <strong>rolling</strong> seven-day window, so words free up as they age out and there is no reset day to wait for',
...
STRINGS.zh = {
  ...
  'home.title': '医疗口译：听懂医生的话，把这次看病的记录带回家',
  'nav.how': '怎么用',
  ...
  'pricing.lede': '两个套餐是同一个口译，语言、科别、所有安全规则都一样。差别只在能说多少。',
  ...
  'plan.free.f2': '按<strong>滚动</strong>的七天算：用掉的词会自己慢慢还回来，不用等某一天清零',
  ...
  'plan.pro.name': '不限量',
  'plan.pro.price': '按月',
  'plan.pro.sub': '通过 Stripe 按月扣费，随时可以取消。',
  ...
  'faq.q3': '医院的翻译还要不要叫？',
  'faq.a3': '要，而且这两个不冲突。在美国，接受联邦经费的医院和诊所必须免费给您提供专业翻译，电话或者到场都行。签字之前一定要叫，知情同意、检查结果、坏消息也一样。这个应用是机器翻译，没有人在您看到之前先审一遍，所以拿它跟上医生在讲什么、事先想好要问什么、把记录留下来。',
  'faq.q4': '录音和记录会怎么处理？',
...
STRINGS.yue = {
  ...
  'home.title': '醫療傳譯：聽得明醫生講嘅嘢，成次應診記錄帶得走',
  'nav.how': '點樣用',
  'nav.features': '唔會譯漏嘅位',
  'nav.pricing': '收費',
  'nav.faq': '常見問題',
  ...
  'pricing.lede': '兩個計劃都係同一個傳譯，語言、科別、所有安全規則一樣。分別淨係喺講得幾多。',
  ...
  'plan.free.f2': '以<strong>滾動</strong>七日計：用咗嘅字會自己慢慢還返，唔使等邊日清零',
  ...
  'plan.pro.name': '無限',
  'plan.pro.price': '月費',
  'plan.pro.sub': '經 Stripe 每月收費，隨時可以取消。',
...
STRINGS.es = {
  ...
  'home.title': 'Intérprete médico: entienda a su doctor y llévese lo que le dijeron',
  ...
  'pricing.lede': 'Los dos planes son el mismo intérprete, con todos los idiomas, todos los tipos de visita y todas las reglas de seguridad. Lo único que cambia es cuánto se puede hablar.',
  ...
  'plan.free.f2': 'Una ventana de siete días <strong>corrida</strong>: las palabras se le van liberando solas y no hay que esperar a ningún día de reinicio',
  ...
  'plan.pro.sub': 'Se cobra cada mes por Stripe. Puede cancelar cuando quiera.',
...
STRINGS.ko = {
  ...
  'home.title': '메디컬 인터프리터 — 의사가 한 말을 알아듣고, 기록으로 가져가세요',
  'nav.how': '사용 방법',
  ...
  'pricing.lede': '두 요금제 모두 같은 통역입니다. 언어도, 과목도, 안전 규칙도 같습니다. 차이는 얼마나 말할 수 있는지뿐입니다.',
  ...
  'plan.free.f2': '7일 <strong>롤링</strong> 기준이라 쓴 단어가 시간이 지나며 저절로 돌아오고, 초기화되는 날을 기다릴 필요가 없습니다',
  ...
  'plan.pro.name': '무제한',
  'plan.pro.price': '월간',
  'plan.pro.sub': 'Stripe로 매월 결제되고, 언제든 해지할 수 있습니다.',
...
STRINGS.ja = {
  ...
  'home.title': '医療通訳 — 医師の説明がわかる、そのまま持ち帰れる',
  'nav.how': '使い方',
  'nav.features': '訳の正確さ',
  'nav.pricing': '料金',
  'nav.faq': 'よくある質問',
  ...
  'pricing.lede': 'どちらのプランも同じ通訳です。言語も診療科も安全のための決まりも同じで、違うのは話せる量だけです。',
  ...
  'plan.free.f2': '7日間の<strong>ローリング</strong>方式。使った分は時間が経つと自然に戻り、リセット日を待つ必要はありません',
  ...
  'plan.pro.name': '無制限',
  'plan.pro.price': '月額',
  'plan.pro.sub': 'Stripeで毎月お支払い。いつでも解約できます。',
