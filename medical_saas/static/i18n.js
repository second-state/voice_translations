...
STRINGS.en = {
  ...
  'faq.a9': 'People speak around 130 to 150 words a minute and both sides count, so {words} words covers a handful of appointments: the questions and the instructions, not the small talk. If you run out in the middle of a visit the app says so, and the allowance comes back over the following week.',
  ...
  'verify.title': 'Confirm sign-in · Medical Translator',
...
STRINGS.zh = {
  ...
  'faq.q9': '免费的一周大概够用多久？',
  'faq.a9': '人说话大概一分钟 130 到 150 个词，而且两边都算，所以 {words} 个词够看好几次门诊：问诊和医嘱的部分，寒暄不算在内。要是看到一半用完了，应用会提示您，额度会在接下来一周里慢慢还回来。',
  'faq.q2': '「滚动」的一周是什么意思？',
  ...
  'login.error.invalid': '这个登录链接已经用过，或者不是有效的链接。请在下方重新获取一个。',
  'login.error.expired': '这个登录链接已经过期。请在下方重新获取一个。',
  'verify.title': '确认登录 · 医疗翻译',
  'verify.lede': '这个链接会在这台设备上为下面的账号开启会话。继续之前，请确认这是您要用的账号。',
  'verify.heading': '以此账号登录',
  'verify.continue': '继续',
  'verify.wrong': '不是这个账号？<a href="/login">为另一个账号获取链接。</a>',
...
STRINGS.yue = {
  ...
  'faq.q9': '免費嗰個星期大概夠用幾耐？',
  'faq.a9': '人講嘢大概一分鐘 130 至 150 個字，而且兩邊都計，所以 {words} 個字夠睇好幾次門診：問診同醫囑嗰部分，傾閒偈唔計。如果睇到一半用完咗，app 會話你知，額度會喺跟住嗰個星期慢慢還返。',
  'faq.q2': '「滾動」嘅一個星期即係點？',
  ...
  'login.error.invalid': '呢條登入連結已經用咗，或者唔係有效嘅連結。請喺下面重新攞一條。',
  'login.error.expired': '呢條登入連結已經過期。請喺下面重新攞一條。',
  'verify.title': '確認登入 · 醫療翻譯',
  'verify.lede': '呢條連結會喺呢部裝置上為下面嘅戶口開啟登入。繼續之前，請確認係你想用嘅戶口。',
  'verify.heading': '用呢個戶口登入',
  'verify.continue': '繼續',
  'verify.wrong': '唔係呢個戶口？<a href="/login">為另一個戶口攞條連結。</a>',
...
STRINGS.es = {
  ...
  'faq.a9': 'La gente habla unas 130 a 150 palabras por minuto y cuentan los dos lados, así que {words} palabras alcanzan para varias citas: las preguntas y las indicaciones, no la plática. Si se le acaban a media visita, la aplicación se lo dice, y la cuota va regresando durante la semana siguiente.',
  ...
  'login.error.invalid': 'Ese enlace de acceso ya se usó o no es válido. Solicite uno nuevo abajo.',
  'login.error.expired': 'Ese enlace de acceso ha caducado. Solicite uno nuevo abajo.',
  'verify.title': 'Confirmar acceso · Traductor Médico',
...
STRINGS.ko = {
  ...
  'faq.a9': '사람은 보통 1분에 130~150단어를 말하고 양쪽이 모두 세어지므로, {words}단어면 외래 진료 여러 번 분량입니다. 인사말이 아니라 묻고 답하고 설명을 듣는 부분이 그렇습니다. 진료 도중에 다 쓰면 앱이 알려주고, 다음 한 주 동안 조금씩 다시 채워집니다.',
  ...
  'login.error.invalid': '이 로그인 링크는 이미 사용되었거나 유효하지 않습니다. 아래에서 새로 요청하세요.',
  'login.error.expired': '이 로그인 링크는 만료되었습니다. 아래에서 새로 요청하세요.',
  'verify.title': '로그인 확인 · 의료 번역',
  'verify.lede': '이 링크는 이 기기에서 아래 계정의 세션을 엽니다. 계속하기 전에 원하시는 계정이 맞는지 확인하세요.',
  'verify.heading': '이 계정으로 로그인',
  'verify.continue': '계속',
  'verify.wrong': '다른 계정이신가요? <a href="/login">다른 계정용 링크를 요청하세요.</a>',
...
STRINGS.ja = {
  ...
  'faq.a9': '人が話す速さはおおよそ1分間に130〜150語で、両方の側が数えられるので、{words} 語で外来診察数回ぶんです。世間話ではなく、質問と説明の部分でその程度です。診察の途中で使い切るとアプリが知らせ、翌週にかけて少しずつ戻ります。',
  'faq.q2': '「ローリング」の1週間とは',
  ...
  'login.error.invalid': 'このログインリンクはすでに使用されているか、有効なリンクではありません。下から新しいリンクを取得してください。',
  'login.error.expired': 'このログインリンクは期限切れです。下から新しいリンクを取得してください。',
  'verify.title': 'ログインの確認 · 医療翻訳',
  'verify.lede': 'このリンクは、この端末で下のアカウントのセッションを開きます。続ける前に、意図したアカウントかご確認ください。',
  'verify.heading': 'このアカウントでログイン',
  'verify.continue': '続ける',
  'verify.wrong': '別のアカウントですか。<a href="/login">別のアカウント用のリンクを取得する</a>',
