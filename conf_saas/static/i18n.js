...
STRINGS.en = {
  ...
  'how.lede': 'Nothing to install, and nothing for the other people on the call to do. It runs in the browser on the laptop or phone that is already in the room. Do tell the others it is running: the translation is there for everyone to read, and some places require that everyone in the conversation knows.',
  ...
  'faq.a2': 'People speak around 130 to 150 words a minute, so {words} words is a short meeting: the decisions and the questions, not an hour of discussion. If you run out mid-call the app says so, and the allowance comes back over the following week.',
  ...
  'faq.q9': 'How does it hear a call on my laptop?',
  'faq.a9': 'Through the device’s microphone, the same way it hears a room. On a video call, let the other side come out of the speakers rather than headphones, and put the laptop where it can hear both them and you. In a meeting room, one laptop or phone on the table is enough.',
  'faq.q10': 'Can I upload a recording I already have?',
  'faq.a10': 'Not yet. It works on a conversation as it happens, listening through the microphone, so there is nowhere to upload a file. What it hands you at the end is a subtitle file you can keep.',
...
STRINGS.zh = {
  ...
  'how.h2': '三步之后，它就不打扰您了',
  'how.lede': '不用装任何东西，会上其他人什么也不用做。在会议室里已经有的那台电脑或手机上，用浏览器打开就行。另外记得告诉在场的人它开着：译文本来就是给所有人看的，而有些地方要求对话里每个人都知情。',
  'how.1.h': '选语言',
  ...
  'faq.q2': '免费的一周大概够用多久？',
  'faq.a2': '人说话大概一分钟 130 到 150 个词，所以 {words} 个词够一次短会：做决定和问问题的部分，不是一个小时的讨论。要是开到一半用完了，应用会提示您，额度会在接下来一周里慢慢还回来。',
  'faq.q3': '「滚动」的一周是什么意思？',
  ...
  'faq.q5': '录音和记录会怎么处理？',
  'faq.a5': '声音会送到这个部署配置的第三方语音识别和翻译服务，再把文字传回来。这台服务器不保存录音，也不保存记录：会议内容留在您的浏览器里，直到您清掉或者导出。您账号里存的是邮箱、有没有订阅，以及每句话用掉多少词。',
  'faq.q6': '怎么登录？',
  ...
  'faq.q9': '用笔记本开的会，它怎么听得到？',
  'faq.a9': '用设备自己的麦克风，跟听一屋子人说话是一样的。开视频会议的时候，把对方的声音从扬声器放出来而不是戴耳机，笔记本摆在能同时听到对方和你的位置。在会议室里，桌上放一台笔记本或手机就够了。',
  'faq.q10': '可以上传已经录好的录音吗？',
  'faq.a10': '暂时不行。它处理的是正在发生的对话，靠麦克风听，所以没有上传文件的地方。它在最后交给您的，是一份可以留着的字幕文件。',
  ...
  'login.expired': '这个登录链接已经过期或者用过了，请重新申请一个。',
...
STRINGS.yue = {
  ...
  'how.h2': '三步之後，佢就唔會阻住你',
  'how.lede': '唔使裝任何嘢，會上其他人乜都唔使做。喺會議室度本身有嗰部電腦或者手機，用瀏覽器開就得。另外記得話畀在場嘅人知佢開住：譯文本來就係畀所有人睇嘅，而有啲地方要求對話裏面每一個人都知情。',
  'how.1.h': '揀語言',
  ...
  'faq.q2': '免費嗰個星期大概夠用幾耐？',
  'faq.a2': '人講嘢大概一分鐘 130 至 150 個字，所以 {words} 個字夠一次短會：做決定同問問題嗰部分，唔係一個鐘嘅討論。如果開到一半用完咗，app 會話你知，額度會喺跟住嗰個星期慢慢還返。',
  'faq.q3': '「滾動」嘅一個星期即係點？',
  ...
  'faq.q5': '錄音同記錄會點處理？',
  'faq.a5': '把聲會送去呢個部署設定嘅第三方語音辨識同翻譯服務，再將文字傳返嚟。呢部伺服器唔會存錄音，亦唔會存記錄：會議內容留喺你個瀏覽器，直到你清走或者匯出。你戶口入面存嘅係電郵、有冇訂閱，同埋每句話用咗幾多個字。',
  'faq.q6': '點樣登入？',
  ...
  'faq.q9': '喺筆記本電腦開嘅會，佢點樣聽得到？',
  'faq.a9': '用部機自己嘅麥克風，同聽一屋人講話係一樣嘅。開視像會議嘅時候，將對面嘅聲音用喇叭放出嚟，唔好戴耳機，然後將部電腦放喺聽得到對面又聽得到你嘅位置。喺會議室裏面，檯面放一部電腦或者手機就夠。',
  'faq.q10': '可唔可以上傳已經錄好嘅錄音？',
  'faq.a10': '暫時唔得。佢處理嘅係正在發生嘅對話，靠麥克風聽，所以冇上傳檔案嘅地方。佢最後畀你嘅，係一份可以留住嘅字幕檔。',
  ...
  'login.expired': '呢個登入連結已經過期或者用過，請重新申請一個。',
...
STRINGS.es = {
  ...
  'faq.a2': 'La gente habla unas 130 a 150 palabras por minuto, así que {words} palabras son una reunión corta: las decisiones y las preguntas, no una hora de discusión. Si se le acaban a media llamada, la aplicación se lo dice, y la cuota va regresando durante la semana siguiente.',
  ...
  'faq.a5': 'La voz se manda a los servicios externos de reconocimiento y traducción que tenga configurados esta instalación, y regresa el texto. Este servidor no guarda ni el audio ni el texto: la llamada se queda en su navegador hasta que usted la borre o la exporte. De su cuenta guardamos el correo, si tiene suscripción y cuántas palabras gastó cada frase.',
  'faq.q6': '¿Cómo entro?',
  ...
  'login.expired': 'Ese enlace de acceso caducó o ya se usó. Pida uno nuevo.',
...
STRINGS.ko = {
  ...
  'how.lede': '설치할 것도 없고, 통화에 참여한 다른 사람들이 할 일도 없습니다. 이미 회의실에 있는 노트북이나 휴대폰의 브라우저에서 돌아갑니다. 켜 두었다는 사실은 참석자들에게 알려 주세요. 번역은 그 자리의 모두가 읽도록 있는 것이고, 지역에 따라 대화에 참여한 모든 사람이 알고 있어야 합니다.',
  'how.1.h': '언어를 고릅니다',
  ...
  'faq.a2': '사람은 보통 1분에 130~150단어를 말하므로 {words}단어면 짧은 회의 한 번입니다. 결정과 질문 정도이지, 한 시간짜리 토론은 아닙니다. 통화 도중에 다 쓰면 앱이 알려주고, 다음 한 주 동안 조금씩 다시 채워집니다.',
  ...
  'faq.a5': '음성은 이 배포에 설정된 외부 음성 인식·번역 서비스로 전송되고 텍스트가 돌아옵니다. 이 서버는 음성도 기록도 저장하지 않습니다. 통화 내용은 지우거나 내보낼 때까지 브라우저에 남습니다. 계정에 남는 것은 이메일 주소, 구독 여부, 각 문장이 쓴 단어 수입니다.',
  'faq.q6': '로그인은 어떻게 하나요?',
  ...
  'faq.q9': '노트북으로 하는 통화는 어떻게 들리나요?',
  'faq.a9': '기기의 마이크로 듣습니다. 회의실의 대화를 듣는 것과 같습니다. 영상 통화에서는 상대방 소리를 이어폰이 아니라 스피커로 내보내고, 상대방 목소리와 내 목소리가 모두 닿는 자리에 노트북을 두세요. 회의실이라면 책상 위에 노트북이나 휴대폰 한 대로 충분합니다.',
  'faq.q10': '이미 녹음해 둔 파일을 올릴 수 있나요?',
  'faq.a10': '아직 안 됩니다. 마이크로 들으면서 진행 중인 대화를 처리하는 방식이라 파일을 올릴 곳이 없습니다. 끝나고 받게 되는 것은 보관할 수 있는 자막 파일입니다.',
  ...
  'login.expired': '이 로그인 링크는 만료되었거나 이미 사용되었습니다. 새로 요청해 주세요.',
...
STRINGS.ja = {
  ...
  'how.lede': 'インストールは不要で、通話の相手側がすることもありません。すでに会議室にあるノートパソコンやスマホのブラウザで動きます。 動かしていることは同席者に伝えてください。訳文はその場の全員が読むためのものですし、地域によっては会話に加わっている全員が知っている必要があります。',
  'how.1.h': '言語を選ぶ',
  ...
  'faq.a2': '人が話す速さはおおよそ1分間に130〜150語なので、{words} 語で短い会議1回ぶんです。決定事項と質問の部分で、1時間の議論ではありません。通話の途中で使い切るとアプリが知らせ、翌週にかけて少しずつ戻ります。',
  'faq.q3': '「ローリング」の1週間とは',
  ...
  'faq.a5': '音声はこの環境に設定された外部の音声認識と翻訳のサービスに送られ、文字が返ってきます。このサーバーは音声も記録も保存しません。通話の内容は、消すか書き出すまでブラウザの中にあります。アカウントに残るのは、メールアドレス、契約の状態、各文で使った語数です。',
  'faq.q6': 'ログインの方法は',
  ...
  'faq.q9': 'ノートパソコンでの通話はどうやって聞き取るのですか？',
  'faq.a9': '端末のマイクで聞き取ります。部屋の会話を聞くのと同じです。ビデオ通話では相手の声をイヤホンではなくスピーカーから出し、相手の声と自分の声の両方が届く位置にパソコンを置いてください。会議室なら、机の上にパソコンかスマートフォンを一台置けば足ります。',
  'faq.q10': 'すでにある録音をアップロードできますか？',
  'faq.a10': '今のところできません。マイクで聞きながら、その場で進んでいる会話を扱う仕組みなので、ファイルをアップロードする場所がありません。最後に受け取れるのは、保存しておける字幕ファイルです。',
  ...
  'login.expired': 'このログイン用リンクは期限切れか、すでに使用されています。新しいものを請求してください。',
